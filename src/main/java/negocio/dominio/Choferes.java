...
public class Choferes extends Users {
	...
	public Choferes(int user_ID, String contrasenia, String nombre, String apellido, Calendar fecha_nac, String telefono, boolean perfil, long chofer, String categoria, ArrayList<Camiones> lista_camiones) {
